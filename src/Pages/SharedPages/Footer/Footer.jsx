...
const Footer = () => {
  return (
    <div className="bg-green-700 text-slate-50 dark:text-slate-900">
      <div className="relative pt-5 px-5 md:px-10 lg:px-0 py-12 md:py-16 lg:py-20 container mx-auto">
        <div className="container grid grid-cols-2 gap-y-10 gap-x-5 sm:gap-x-8 md:grid-cols-4 lg:grid-cols-5 lg:gap-x-10">
          <div className="grid grid-cols-4 gap-5 col-span-2 md:col-span-4 lg:md:col-span-1 lg:flex lg:flex-col">
            <div className="col-span-2 md:col-span-1">
              {/* Logo */}
              <Link to="/" className="flex justify-start items-center gap-2 font-semibold text-xl lg:text-2xl font-primary">
          ...
          <div className="text-sm">
            <h2 className="font-semibold text-xl lg:text-2xl font-primary">Community</h2>
            <ul className="mt-5 space-y-4">
              <li>
                <Link to="" className="text-base hover:underline" target="_blank">
                  Discussion Forums
